...
#
# EXT:yellowpages2 test runner based on docker/podman.
#
...
loadHelp() {
    ...
    read -r -d '' HELP <<EOF
EXT:yellowpages2 test runner. Check code styles, lint PHP files and some other details.
