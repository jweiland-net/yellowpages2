...
/*
 * Use this event, if you want to add further checks for uploaded images of yellowpages2 frontend form
 */
final readonly class PostCheckFileReferenceEvent
{
    public function __construct(
         ...
         */
        private ?FileReference $alreadyPersistedImage,
        /**
